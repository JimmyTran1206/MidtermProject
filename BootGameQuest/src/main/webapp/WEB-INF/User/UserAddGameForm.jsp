					...
					<div class="col-10 text-center">
						<div>
							<label class="form-label">Trailer</label> <input type="text"
								class="form-control text-center" name="trailerUrl" required />
						</div>
