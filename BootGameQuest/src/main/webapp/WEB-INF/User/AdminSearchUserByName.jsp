										...
										<div class="row text-center">
											...
											<div class="col-4">
												<input type="number" min="2" class="form-control"
													id="user-id" name="searchId" required />
											</div>
											<div class="col-3">
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<a href="viewAllUsers.do" class="btn btn-success my-2 mx-2">
							Show full User List </a>
					</div>
				</div>
			</div>
		</main>
				...
				<c:choose>
					...
					<c:when test="${empty userList}">
						<div style="max-width: 800px">
							<h3>There is no user matched the specified name ${name}.
								Please try again or review the list of all users</h3>
						</div>
					</c:when>
